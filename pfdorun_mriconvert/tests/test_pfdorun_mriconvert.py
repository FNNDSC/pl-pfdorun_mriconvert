...
from pfdorun_mriconvert.pfdorun_mriconvert import Pfdorun_mriconvert


class Pfdorun_mriconvertTests(TestCase):
    """
    Test Pfdorun_mriconvert.
    """
    def setUp(self):
        self.app = Pfdorun_mriconvert()
